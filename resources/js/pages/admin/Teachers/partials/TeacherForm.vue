...
<template>
    <form @submit.prevent="emit('submit')" class="space-y-6">
        ...
        <div class="rounded-xl border border-brand-border bg-brand-surface p-5">
            <h3 class="mb-4 text-lg font-semibold text-brand-text">Basic Details</h3>
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                    <label class="mb-1 block text-sm font-medium text-brand-text">Name *</label>
                    <input
                        v-model="form.name"
                        type="text"
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                    />
                    <p v-if="form.errors.email" class="mt-1 text-xs text-brand-danger">{{ form.errors.email }}</p>
                </div>
                <div>
                ...
                <div>
                    <label class="mb-1 block text-sm font-medium text-brand-text">How they found us</label>
                    <input
        ...
        <!-- Contact Status -->
        <div class="rounded-xl border border-brand-border bg-brand-surface p-5">
            <h3 class="mb-4 text-lg font-semibold text-brand-text">Contact Status</h3>
            <div class="flex flex-wrap gap-4">
                <label class="flex cursor-pointer items-center gap-2">
                    ...
                    <span class="text-sm text-brand-text">Contacted by email</span>
                </label>
                <label class="flex cursor-pointer items-center gap-2">
                    ...
                    <span class="text-sm text-brand-text">Spoken on phone</span>
                </label>
                <label class="flex cursor-pointer items-center gap-2">
                    ...
                    <span class="text-sm text-brand-text">Met face to face</span>
                </label>
            </div>
        </div>
        ...
        <!-- Schools -->
        <div class="rounded-xl border border-brand-border bg-brand-surface p-5">
            <h3 class="mb-4 text-lg font-semibold text-brand-text">Schools</h3>
        ...
        <!-- Instruments -->
        <div class="rounded-xl border border-brand-border bg-brand-surface p-5">
            <h3 class="mb-4 text-lg font-semibold text-brand-text">Instruments</h3>
            <div class="space-y-4">
                <div v-for="(instruments, family) in instrumentsByFamily" :key="family">
                    <p class="mb-2 text-xs font-semibold uppercase tracking-wider text-brand-text-soft">{{ family }}</p>
                    <div class="flex flex-wrap gap-2">
                        <button
        ...
        <!-- Subject Areas -->
        <div class="rounded-xl border border-brand-border bg-brand-surface p-5">
            <h3 class="mb-4 text-lg font-semibold text-brand-text">Subject Areas</h3>
            <div class="flex flex-wrap gap-2">
                <button
        ...
        <div class="flex items-center justify-end gap-3">
            <Link href="/admin/teachers">
                <MyButtonConstructor variant="ghost" size="medium" :icon="X">
                    Cancel
                </MyButtonConstructor>
            </Link>
            <MyButtonConstructor
