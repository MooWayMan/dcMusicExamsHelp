                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%;">
                    ...
                    <tr>
                        <td style="background: linear-gradient(to right, #1e3a5f, #3B82F6, #1e3a5f); padding: 24px 32px; border-radius: 12px 12px 0 0; text-align: center;">
                            <img src="https://moowaymusicbucket.s3.eu-west-2.amazonaws.com/musicexamshelp/ME_Logo_square_icon.png" alt="musicExams.help" width="48" height="48" style="display: inline-block; border-radius: 8px; margin-bottom: 12px;" />
